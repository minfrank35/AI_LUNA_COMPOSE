package com.example.ai_luna_compose.data.repository
...
class ChatDetailRepositoryImpl : ChatDetailRepository {
    override suspend fun getChatList(index: Int): Result<List<ChatItemEntity>> {
        ...
        val successResult = Result.success(chatItems)
